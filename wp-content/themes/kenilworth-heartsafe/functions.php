...
function awesome_page_create()
{
    ...
    function sitewide_settings_display()
    {
        ...
        //== Alert Banner Text
        if (isset($_POST['alert_banner'])) {
            $alert_banner = $_POST['alert_banner'];
            update_option('alert_banner', $alert_banner);
        }
        $alert_banner = get_option('alert_banner', '');
        ...
        <form method="POST">
            ...
            <div class="settingsGroup">
                <label for="alert_banner">Alert Banner</label><br>
                <input type="text" name="alert_banner" id="alert_banner" value="<?php echo $alert_banner; ?>">
            </div>
