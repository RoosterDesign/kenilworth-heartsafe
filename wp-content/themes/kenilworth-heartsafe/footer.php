    ...
    <div class="container">
        <div class="site-footer__col site-footer__col--first">
            ...
            <a href="/" title="Kenilworth Heartsafe" class="site-footer__logo">
                <img src="<?php echo get_template_directory_uri(); ?>/images/logo.png" alt="Kenilworth Heartsafe"
            ...
            <ul class="footer-social">
                ...
                <?php if (get_option('facebook_link')): ?>
                    <li class="footer-social__item">
                        <a href="<?php echo get_option('facebook_link'); ?>" target="_blank" title="Find us on Facebook"
                ...
                <?php if (get_option('x_link')): ?>
                    <li class="footer-social__item">
                        <a href="<?php echo get_option('x_link'); ?>" target="_blank" title="Find us on X"
                            class="footer-social__link">
 ...
 */ ?>
            ...
            <p>
                <?php if (get_option('email_address')): ?>
                    ...
                    <a href="mailto:<?php echo get_option('email_address'); ?>?subject=Website Enquiry" target="_blank"
                        title="Email Kenilworth Heartsafe"><?php echo get_option('email_address'); ?></a>
                <?php endif; ?>
            </p>
        ...
        <div class="site-footer__col site-footer__col--donate">
            ...
            <a href="<?php echo get_option('donate_link'); ?>" title="Donate" target="_blank"
                class="btn btn--primary btn--alt site-footer__donate-btn">Donate</a>
        </div>
